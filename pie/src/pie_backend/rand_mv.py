...
# ------------------------------------------------------------
#
# NOTE: This module requires CUDA. It is disabled on non-CUDA platforms
# (e.g., Apple Metal) to prevent crashes.
# ------------------------------------------------------------
...
if not RAND_MV_AVAILABLE:
    ...
    # CUDA is available - import Triton and define all functions
    import triton
