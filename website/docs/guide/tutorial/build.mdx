...
The Python tab adds `python-runtime = "^0.4.0"` to `[runtime]`. Bakery does not scaffold Python projects yet; copy `inferlets/python-example` as a starting point and keep that runtime entry in `Pie.toml`.
