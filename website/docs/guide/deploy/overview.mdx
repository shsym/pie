...
- **Multiple engines.** A pool of engines behind a load balancer. The registry is shared. Each engine runs the same set of inferlets independently. Cross-engine saved contexts do not propagate.
