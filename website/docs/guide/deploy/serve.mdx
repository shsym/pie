...
Both load on startup. Inside an inferlet, bind by name (`Model::load("small")` / `Model::load("large")`). See [Loading and selecting models](../model/loading) for the inferlet-side surface.
