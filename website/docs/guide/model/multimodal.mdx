...
`Image::from_bytes` decodes synchronously and exposes metadata before any forward pass: `token_count()` (soft tokens the image will occupy) and `grid()` (the `(t, h, w)` merged-token layout). See the [`image-qa`](https://github.com/pie-project/pie/tree/main/inferlets/image-qa) inferlet for the full example.
...
See the [`audio-qa`](https://github.com/pie-project/pie/tree/main/inferlets/audio-qa) inferlet.
...
See the [`video-qa`](https://github.com/pie-project/pie/tree/main/inferlets/video-qa) inferlet.
...
See the [`tts`](https://github.com/pie-project/pie/tree/main/inferlets/tts) inferlet.
