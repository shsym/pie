...
`pie model list` reports compatibility. Architectures the native driver supports get a `✓`. The full list of supported architectures is on the [CUDA driver](../reference/drivers/cuda#supported-architectures) page.
