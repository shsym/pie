...
- **Parallel candidates.** Fork from a shared prefix and rank the outputs. See [`consensus-decoding`](https://github.com/pie-project/pie/tree/main/inferlets/consensus-decoding).
- **Tree search.** Explore continuations in parallel and prune low-scoring branches.
...
- [Examples](../../guide/examples/overview): [`consensus-decoding`](https://github.com/pie-project/pie/tree/main/inferlets/consensus-decoding) and [`prefix-tree-kv-cache`](https://github.com/pie-project/pie/tree/main/inferlets/prefix-tree-kv-cache) demonstrate shared-prefix branching.
