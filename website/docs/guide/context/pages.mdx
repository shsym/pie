...
Pages cap how finely you can slice a prefix. A 1000-token prompt with 16-token pages lives in 62 full pages plus an 8-token working page. If you save this context as a snapshot and fork from it, every fork shares those 62 committed pages and gets its own copy of the working page.
