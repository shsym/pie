...
See the [`windowed-attention`](https://github.com/pie-project/pie/tree/main/inferlets/windowed-attention) inferlet for the full implementation.
...
The high-level idioms (sliding window with whole-page eviction, attention sink, page-aligned sparse attention) all align with these rules. See the [`page-trim-bench`](https://github.com/pie-project/pie/tree/main/inferlets/page-trim-bench) inferlet for measurements.
