...
See [`sampling-primitives`](https://github.com/pie-project/pie/tree/main/inferlets/sampling-primitives) for direct access to logits, probabilities, log-probabilities, and entropy.
