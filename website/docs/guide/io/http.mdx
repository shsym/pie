...
The [`http-server`](https://github.com/pie-project/pie/tree/main/inferlets/http-server) inferlet shows the inverse pattern: an inferlet that *serves* HTTP, including SSE streaming.
...
- [MCP](./mcp): structured tool servers as an alternative to raw HTTP.
