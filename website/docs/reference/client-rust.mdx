...
The Rust client is published on crates.io as [`pie-client`](https://crates.io/crates/pie-client).
...
`authenticate` runs a challenge-response handshake. If the server has
