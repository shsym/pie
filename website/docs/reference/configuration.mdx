...
| Key | Default | Description |
|-----|---------|-------------|
| `type` | required | Driver name. One of `portable`, `cuda_native`, `dummy`, `dev`, `vllm`, `sglang`, `tensorrt_llm`. See the per-driver reference pages. |
