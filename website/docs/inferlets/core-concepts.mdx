...
See also: [parallel generation](./examples#parallel-generation) and [tree-of-thought](./examples#tree-of-thought) examples.
...
See also: [prefix caching](./examples#prefix-caching) and [attention sink](./examples#attention-sink) examples.
...
See also: [constrained decoding](./examples#constrained-decoding), [cacheback decoding](./examples#cacheback-decoding), and [output validation](./examples#output-validation) examples.
