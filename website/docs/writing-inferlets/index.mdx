...
9. **[Sampler Outputs](./sampler-outputs)** — Distributions, raw logits, logprobs, and entropy
10. **[Speculative Decoding](./speculative-decoding)** — Implement custom speculation strategies
11. **[Adapters & Fine-tuning](./adapters)** — Manage adapters and run zeroth-order optimization

### System Integration
12. **[I/O & Messaging](./io)** — HTTP, file I/O, client messaging, broadcast/subscribe, and spawning
13. **[MCP Integration](./mcp)** — Connect to Model Context Protocol servers

### Deployment
14. **[Building & Publishing](./building-publishing)** — Build pipeline, bakery, and the registry
