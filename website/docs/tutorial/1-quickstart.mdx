...
Make sure you have:
- Pie installed ([Installation Guide](../installation/index.mdx))
...
- Learn about [Server Mode](./2-server-mode.mdx) for persistent serving
- Connect from code with [Client Basics](./3-client-basics.mdx)
