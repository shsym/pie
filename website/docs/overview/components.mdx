...
- **Driver** (`driver/`). The hardware layer. Pie ships a CUDA driver, and a local driver for CPU and Apple Silicon. Pie also has experimental support for vLLM, SGLang, and TensorRT-LLM as drivers.
