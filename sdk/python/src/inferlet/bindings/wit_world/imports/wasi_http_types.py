...
class Fields:
    ...
    def from_list(cls, entries: List[Tuple[str, bytes]]) -> Self:
        ...
        Raises: `componentize_py_types.Err(wit_world.imports.wasi_http_types.HeaderError)`
        """
        raise NotImplementedError
...
class RequestOptions:
    ...
    def set_connect_timeout(self, duration: Optional[int]) -> None:
        ...
        Raises: `componentize_py_types.Err(wit_world.imports.wasi_http_types.RequestOptionsError)`
        """
        raise NotImplementedError
