...
export class ForwardPass {
  ...
  * states it (media-door.md §0/§3): spans order-matched to the
  * placeholder runs in the submitted tokens, scanned at `submit`. A
  * hybrid tower family (qwen3.8-flash-next: a vision tower over a
  * GDN/attention/PLE trunk) is what brought the verb here; the host
  * half is the attention interface's, unchanged.
  */
