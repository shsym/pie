...
from ..imports import pie_inferlet_types
...
class Channel:
    ...
    def __init__(self, shape: List[int], dtype: pie_inferlet_types.Dtype, capacity: int) -> None:
