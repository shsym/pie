...
// The Rust runtime is the client (writes requests + bumps req_seq). pie_cuda_driver is
// the server (polls slots, handles requests, writes responses + bumps resp_seq).
