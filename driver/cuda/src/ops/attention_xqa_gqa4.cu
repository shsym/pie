...
// FlashInfer XQA specialization for head_group_size=4, used by medium Qwen
// GQA models such as Qwen3-4B and Qwen3-8B.
#define NDEBUG 1
#define BEAM_WIDTH 1
...
#define launchMHA launchMHA_xqa_gqa4_bf16_p32_h128
#define launchMHAFlashInfer launchMHAFlashInfer_xqa_gqa4_bf16_p32_h128
    ...
    float sm_scale)
{
    ...
    prepare_attention_xqa_decode_bf16(
        ...
        workspace,
        stream);
    launch_attention_xqa_decode_bf16_gqa4_prepared(
        q,
        k_pages,
        v_pages,
        o,
    ...
    float sm_scale)
{
    ...
    launchMHAFlashInfer_xqa_gqa4_bf16_p32_h128(
