...
#include "model/gemma4.hpp"                 // Gemma4AudioWeights (defines PIE_HAS_GEMMA4_AUDIO_WEIGHTS)
#include "model/gemma4_audio_forward.hpp"  // AudioRawWeights, run_gemma4_audio
