...
//
// EXPECTED upstream type (lives in the SHARED `model/qwen3.hpp`, which this task
// must NOT edit — a teammate wires the bind there). The adapter is written
// against this minimal contract; adjust field names to match the final struct:
//
...
#include "model/qwen3_vl.hpp"                 // Qwen3VLVisionWeights
#include "model/qwen3_vl_vision_forward.hpp"  // QwenVisRawWeights, run_qwen3vl_vision
