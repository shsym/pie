...
#include "model/qwen3_vl_vision_forward.hpp"  // QwenVisRawWeights
...
public:
    Qwen3VLModel(
        ...
        // Vision tower (nullptr = text-only checkpoint, should not happen for
        // qwen3_vl but kept for symmetry with gemma4).
