...
// PTIR tier-1 JIT fusion codegen (docs/ptir/thrust-3-programs.md P5, overview
// §7.3 "Tier 1 — fuse"). Generalizes the shipped Sampling-IR NVRTC codegen from
...
// into the epilogue (P5.3) — modeled here at the launch boundary for the tier-1
...
// JIT (delta's JitEngine or the test harness) NVRTC-compiles + caches it by the
