...
# ------------------------------------------------------------
#
# NOTE: This module requires CUDA + Triton. Import is guarded by the
# `pie_kernels.rand_mv` dispatcher; do not import this module directly from
# callers — import from `pie_kernels.rand_mv` instead.
# ------------------------------------------------------------
