...
def _leader_loop(
    ...
    import msgpack
    import torch.distributed as dist
    from pie_driver_dev import utils, message
    from pie_driver_dev.batching import Batch
    from pie_driver_dev.latency import StepTiming, LatencyStats
    ...
    from pie_driver_dev import shmem_ipc as _shm
    from pie_driver_dev import shmem_schema as _shm_schema
...
def _follower_loop(
    ...
    import torch
    import torch.distributed as dist
    from pie_driver_dev import utils
