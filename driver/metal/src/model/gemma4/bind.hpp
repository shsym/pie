...
// ScratchBind / ScratchColoring / color_gemma4_scratch moved to scratch.hpp
// (included above): the colourer is pure dataflow and compiles host-side on
// every platform; this header keeps the Metal-only binding surface.
