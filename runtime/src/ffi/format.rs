//! FFI format module containing request/response types for Python-Rust communication.
//!
//! These types define the serialization format for IPC messages between
//! the Rust runtime and Python worker processes.
