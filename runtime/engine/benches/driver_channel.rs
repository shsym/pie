...
//!
//! - `inproc_channel/*` uses `pie_engine::driver::InProcChannel::submit`,
...
//!   `pie_engine::driver::InProcPollingChannel::submit`, the same FFI callbacks,
//!   and fixed preallocated slots with polling/yield waits.
//! - `shmem_channel/*` uses `pie_engine::driver::ShmemChannel::submit` and a
