...
Usage:
    python scripts/synthesize_eagle_head.py <base-snapshot-dir> <out.safetensors>

The gemma prefix is the mlx-community spelling (`language_model.model.layers`);
the google spelling is `model.language_model.layers`.
