...
//!
//! [`EmittedKernel::error`]: crate::program::EmittedKernel::error
//! [`CompiledStage`]: https://github.com/pie-project/pie/tree/dev/compiler/plan
//! [`METAL_M2_MAX_FUSED_CHANNELS`]: crate::metal::METAL_M2_MAX_FUSED_CHANNELS
...
mod tests {
    ...
    fn the_channel_limit_message_reads_the_constant() {
        ...
        .to_string();
        assert!(
            rendered.contains(&crate::metal::METAL_M2_MAX_FUSED_CHANNELS.to_string()),
