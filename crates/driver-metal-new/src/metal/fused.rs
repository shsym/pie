...
//! same [`Outcome::of`](crate::pipeline::StatusOutcome) every other path
//! uses.
//!
...
use super::fire::{DeviceInputs, PreparedFire};
...
impl M2Command {
    ...
    pub fn set_logits_row(&mut self, row: u32) -> Result<()> {
        ...
        let shape = crate::pipeline::LaneShape::of(1, self.fire.rings.len() as u32);
