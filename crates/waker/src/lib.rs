//! # X0 — the tensor-waker substrate (Runtime–Engine Boundary, B9–B12)
//!
//! Host-side dual of contract **C2**: futures park on the same ring indices
//! the engine cuts on, woken by the engine (or mock) through this table. Owns
...
//!
//! Spurious wakes are permitted; mock and real engine share the `pie_wake*` FFI.
