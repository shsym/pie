...
//! engine's RS pool is a single id space (`rs_slot_ids` address it directly),
...
//!   engine dispatch; a committed fold advances the folded boundary and drops
...
/// learned — the device computed it and only the engine ever saw the value.
