...
fn serving_artifact_every_case() {
    ...
    the_stamp_comes_back_whole_and_a_mismatch_names_the_field();
    a_profile_version_this_build_does_not_implement_is_not_a_broken_file();
    an_open_hashes_nothing_and_a_verify_is_what_finds_the_rot();
    a_flipped_byte_is_named_by_its_object_and_its_block();
    an_entry_subset_verify_reaches_only_its_own_blocks();
    a_prefix_of_the_sequence_verifies_without_reading_the_rest();
    a_file_written_at_one_alignment_verifies_under_another();
    the_header_door_and_the_mapping_door_say_the_same_thing();
    a_deployment_built_the_same_way_accepts_the_artifact();
