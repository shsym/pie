...
//! `elementwise.res_blend`, `attention.merge_lse`, every collective, and
...
use engine::fire::{FireDescriptor, Lane as FireLane, compose, walk};
...
impl Shell {
    ...
    #[must_use]
    pub fn program_stats(&self) -> engine::CacheStats {
        self.programs.stats()
    }
