// Vendored from MLX, MIT licensed. the simdgroup-matrix GEMM: BaseMMAFrag, MMATile, BlockMMA
//
// Upstream: steel/gemm/mma.h
//
...
#ifndef PIE_MLX_STEEL_MMA_METAL
#define PIE_MLX_STEEL_MMA_METAL
