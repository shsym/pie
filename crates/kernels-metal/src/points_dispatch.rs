    ...
    B: BoundOp<Plane = Ctx<'p>>,
{
    match op.point() {
        "norm.rmsnorm" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.rmsnorm::<bfloat>(op.tin::<bfloat>(0)?, op.tconst::<bfloat>(0)?, op.f32(0)?, op.tout::<bfloat>(0)?),
        ...
        "norm.rmsnorm_per_head" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.rmsnorm_per_head::<bfloat>(op.tin::<bfloat>(0)?, op.tconst::<bfloat>(0)?, op.u32(0)?, op.f32(1)?, op.tout::<bfloat>(0)?),
        ...
        "norm.rmsnorm_plus_one" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.rmsnorm_plus_one::<bfloat>(op.tin::<bfloat>(0)?, op.tconst::<bfloat>(0)?, op.f32(0)?, op.tout::<bfloat>(0)?),
        ...
        "norm.rmsnorm_per_head_plus_one" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.rmsnorm_per_head_plus_one::<bfloat>(op.tin::<bfloat>(0)?, op.tconst::<bfloat>(0)?, op.u32(0)?, op.f32(1)?, op.tout::<bfloat>(0)?),
        ...
        "norm.rmsnorm_no_scale" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.rmsnorm_no_scale::<bfloat>(op.tin::<bfloat>(0)?, op.u32(0)?, op.f32(1)?, op.tout::<bfloat>(0)?),
        ...
        "norm.rmsnorm_gated" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.rmsnorm_gated::<bfloat>(op.tin::<f32>(0)?, op.tin::<bfloat>(1)?, op.tconst::<f32>(0)?, op.u32(0)?, op.f32(1)?, op.tout::<bfloat>(0)?),
        ...
        "norm.rmsnorm_gated_by" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.rmsnorm_gated_by::<bfloat>(op.tin::<f32>(0)?, op.tin::<bfloat>(1)?, op.tconst::<f32>(0)?, op.u32(0)?, op.f32(1)?, op.tout::<bfloat>(0)?),
        ...
        "norm.residual_add" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.residual_add::<bfloat>(op.tin::<bfloat>(0)?, op.tinout::<bfloat>(1, 0)?),
        ...
        "norm.add_bias" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.add_bias::<bfloat>(op.tconst::<bfloat>(0)?, op.tinout::<bfloat>(0, 0)?),
        ...
        "norm.mul_scalar" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.mul_scalar::<bfloat>(op.f32(0)?, op.tinout::<bfloat>(0, 0)?),
        ...
        "norm.scale" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.scale::<bfloat>(op.tconst::<bfloat>(0)?, op.tinout::<bfloat>(0, 0)?),
        ...
        "mlp.swiglu" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.swiglu::<bfloat>(op.tin::<bfloat>(0)?, op.u32(0)?, op.tout::<bfloat>(0)?),
        ...
        "mlp.swiglu_clamp" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.swiglu_clamp::<bfloat>(op.tin::<bfloat>(0)?, op.u32(0)?, op.f32(1)?, op.tout::<bfloat>(0)?),
        ...
        "mlp.swiglu_clamp_alpha" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.swiglu_clamp_alpha::<bfloat>(op.tin::<bfloat>(0)?, op.u32(0)?, op.f32(1)?, op.f32(2)?, op.tout::<bfloat>(0)?),
        ...
        "mlp.geglu_tanh" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.geglu_tanh::<bfloat>(op.tin::<bfloat>(0)?, op.tin::<bfloat>(1)?, op.tout::<bfloat>(0)?),
        ...
        "mlp.geglu_tanh_packed" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.geglu_tanh_packed::<bfloat>(op.tin::<bfloat>(0)?, op.u32(0)?, op.tout::<bfloat>(0)?),
        ...
        "mlp.situ" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.situ::<bfloat>(op.tin::<bfloat>(0)?, op.u32(0)?, op.f32(1)?, op.f32(2)?, op.tout::<bfloat>(0)?),
        ...
        "gemm.matmul" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.matmul::<bfloat>(op.tin::<bfloat>(0)?, op.tconst::<bfloat>(0)?, op.tout::<bfloat>(0)?),
        ...
        "gemm.lm_head" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.lm_head::<bfloat>(op.tin::<bfloat>(0)?, op.tconst::<bfloat>(0)?, op.tout::<bfloat>(0)?),
        ...
        "gemm.attention_landing" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.attention_landing::<bfloat>(op.tin::<bfloat>(0)?, op.tconst::<bfloat>(0)?, op.layer()?, op.tout::<bfloat>(0)?),
        ...
        "rope.full" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.full::<bfloat>(op.tinout::<bfloat>(0, 0)?, op.tinout::<bfloat>(1, 1)?, op.tin::<i32>(2)?, op.u32(0)?, op.f32(1)?, op.bool(2)?),
        ...
        "rope.partial" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.partial::<bfloat>(op.tinout::<bfloat>(0, 0)?, op.tinout::<bfloat>(1, 1)?, op.tin::<i32>(2)?, op.u32(0)?, op.u32(1)?, op.f32(2)?),
        ...
        "rope.partial_q" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.partial_q::<bfloat>(op.tinout::<bfloat>(0, 0)?, op.tin::<i32>(1)?, op.u32(0)?, op.u32(1)?, op.f32(2)?),
        ...
        "rope.partial_last" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.partial_last::<bfloat>(op.tinout::<bfloat>(0, 0)?, op.tin::<i32>(1)?, op.u32(0)?, op.u32(1)?, op.f32(2)?, op.bool(3)?),
        ...
        "rope.yarn" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.yarn::<bfloat>(op.tinout::<bfloat>(0, 0)?, op.tinout::<bfloat>(1, 1)?, op.tin::<i32>(2)?, op.u32(0)?, op.f32(1)?, op.f32(2)?, op.f32(3)?, op.f32(4)?, op.f32(5)?, op.u32(6)?, op.bool(7)?),
        ...
        "moe.topk_softmax" => match op.dtype(Site::In(0))? {
            ScalarKind::Bf16 => ctx.topk_softmax::<bfloat>(op.tin::<bfloat>(0)?, op.u32(0)?, op.u32(1)?, op.tout::<i32>(0)?, op.tout::<f32>(1)?),
        ...
        "moe.topk_sigmoid" => match op.dtype(Site::In(0))? {
            ScalarKind::Bf16 => ctx.topk_sigmoid::<bfloat>(op.tin::<bfloat>(0)?, op.u32(0)?, op.u32(1)?, op.bool(2)?, op.f32(3)?, op.tout::<i32>(0)?, op.tout::<f32>(1)?),
        ...
        "moe.topk_sqrt_softplus" => match op.dtype(Site::In(0))? {
            ScalarKind::Bf16 => ctx.topk_sqrt_softplus::<bfloat>(op.tin::<bfloat>(0)?, op.tconst::<f32>(0)?, op.u32(0)?, op.u32(1)?, op.bool(2)?, op.f32(3)?, op.tout::<i32>(0)?, op.tout::<f32>(1)?),
        ...
        "moe.matmul_select" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.matmul_select::<bfloat>(op.tin::<bfloat>(0)?, op.tconst::<bfloat>(0)?, op.tin::<i32>(1)?, op.tout::<bfloat>(0)?),
        ...
        "moe.matmul_select_bias" => match (op.dtype(Site::Out(0))?, op.form(0)?) {
            (ScalarKind::Bf16, Form::Mxfp4) => ctx.matmul_select_bias::<bfloat, Mxfp4>(op.tin::<bfloat>(0)?, op.bank::<Mxfp4>(0)?, op.tconst::<bfloat>(2)?, op.tin::<i32>(1)?, op.tout::<bfloat>(0)?),
        ...
        "moe.weighted_sum" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.weighted_sum::<bfloat>(op.tin::<bfloat>(0)?, op.tin::<f32>(1)?, op.tout::<bfloat>(0)?),
        ...
        "moe.sigmoid_gate_add" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.sigmoid_gate_add::<bfloat>(op.tin::<bfloat>(0)?, op.tin::<bfloat>(1)?, op.tin::<bfloat>(2)?, op.tout::<bfloat>(0)?),
        ...
        "gate.sigmoid_mul" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.sigmoid_mul::<bfloat>(op.tinout::<bfloat>(0, 0)?, op.tin::<bfloat>(1)?),
        ...
        "layout.embed" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.embed::<bfloat>(op.tin::<i32>(0)?, op.tconst::<bfloat>(0)?, op.u32(0)?, op.tout::<bfloat>(0)?),
        ...
        "layout.split_qkv" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.split_qkv::<bfloat>(op.tin::<bfloat>(0)?, op.u32(0)?, op.u32(1)?, op.tout::<bfloat>(0)?, op.tout::<bfloat>(1)?, op.tout::<bfloat>(2)?),
        ...
        "layout.split_q_gate" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.split_q_gate::<bfloat>(op.tin::<bfloat>(0)?, op.u32(0)?, op.tout::<bfloat>(0)?, op.tout::<bfloat>(1)?),
        ...
        "layout.split_rows" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.split_rows::<bfloat>(op.tin::<bfloat>(0)?, op.u32(0)?, op.tout::<bfloat>(0)?, op.tout::<bfloat>(1)?),
        ...
        "layout.select" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.select::<bfloat>(op.tin::<bfloat>(0)?, op.u32(0)?, op.u32(1)?, op.tout::<bfloat>(0)?),
        ...
        "ssm.causal_conv1d" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.causal_conv1d::<bfloat>(op.tin::<bfloat>(0)?, op.tconst::<bfloat>(0)?, op.recurrent()?, op.u32(0)?, op.tout::<bfloat>(0)?),
        ...
        "ssm.causal_conv1d_chunked" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.causal_conv1d_chunked::<bfloat>(op.tin::<bfloat>(0)?, op.tin::<i32>(1)?, op.tconst::<bfloat>(0)?, op.recurrent()?, op.u32(0)?, op.tout::<bfloat>(0)?),
        ...
        "ssm.gdn_prep" => match op.dtype(Site::In(0))? {
            ScalarKind::Bf16 => ctx.gdn_prep::<bfloat>(op.tin::<bfloat>(0)?, op.tconst::<bfloat>(0)?, op.tconst::<f32>(1)?, op.tout::<f32>(0)?),
        ...
        "ssm.gated_delta" => match op.dtype(Site::In(0))? {
            ScalarKind::Bf16 => ctx.gated_delta::<bfloat>(op.tin::<bfloat>(0)?, op.tin::<bfloat>(1)?, op.tin::<f32>(2)?, op.recurrent()?, op.u32(0)?, op.u32(1)?, op.u32(2)?, op.u32(3)?, op.tout::<f32>(0)?),
        ...
        "ssm.gated_delta_chunked" => match op.dtype(Site::In(0))? {
            ScalarKind::Bf16 => ctx.gated_delta_chunked::<bfloat>(op.tin::<bfloat>(0)?, op.tin::<i32>(1)?, op.tin::<bfloat>(2)?, op.tin::<f32>(3)?, op.recurrent()?, op.u32(0)?, op.u32(1)?, op.u32(2)?, op.u32(3)?, op.tout::<f32>(0)?),
        ...
        "ssm.kda_step" => match op.dtype(Site::In(0))? {
            ScalarKind::Bf16 => ctx.kda_step::<bfloat>(op.tin::<bfloat>(0)?, op.tin::<bfloat>(1)?, op.tin::<bfloat>(2)?, op.tconst::<f32>(0)?, op.tconst::<f32>(1)?, op.recurrent()?, op.u32(0)?, op.u32(1)?, op.f32(2)?, op.tout::<f32>(0)?),
        ...
        "ssm.kda_chunked" => match op.dtype(Site::In(0))? {
            ScalarKind::Bf16 => ctx.kda_chunked::<bfloat>(op.tin::<bfloat>(0)?, op.tin::<i32>(1)?, op.tin::<bfloat>(2)?, op.tin::<bfloat>(3)?, op.tconst::<f32>(0)?, op.tconst::<f32>(1)?, op.recurrent()?, op.u32(0)?, op.u32(1)?, op.f32(2)?, op.tout::<f32>(0)?),
        ...
        "attention.decode" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.decode::<bfloat>(op.tin::<bfloat>(0)?, op.pages()?, op.u32(0)?, op.u32(1)?, op.f32(2)?, op.tout::<bfloat>(0)?),
        ...
        "attention.prefill" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.prefill::<bfloat>(op.tin::<bfloat>(0)?, op.tin::<i32>(1)?, op.pages()?, op.u32(0)?, op.u32(1)?, op.u32(2)?, op.f32(3)?, op.tout::<bfloat>(0)?),
        ...
        "attention.masked" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.masked::<bfloat>(op.tin::<bfloat>(0)?, op.tin::<i32>(1)?, op.pages()?, op.u32(0)?, op.u32(1)?, op.f32(2)?, op.tout::<bfloat>(0)?),
        ...
        "attention.decode_lse" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.decode_lse::<bfloat>(op.tin::<bfloat>(0)?, op.pages()?, op.u32(0)?, op.u32(1)?, op.f32(2)?, op.tout::<bfloat>(0)?, op.tout::<f32>(1)?),
        ...
        "attention.prefill_lse" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.prefill_lse::<bfloat>(op.tin::<bfloat>(0)?, op.tin::<i32>(1)?, op.pages()?, op.u32(0)?, op.u32(1)?, op.u32(2)?, op.f32(3)?, op.tout::<bfloat>(0)?, op.tout::<f32>(1)?),
        ...
        "attention.sink" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.sink::<bfloat>(op.tinout::<bfloat>(0, 0)?, op.tin::<f32>(1)?, op.tconst::<bfloat>(0)?, op.u32(0)?),
        ...
        "attention.logit_softcap" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.logit_softcap::<bfloat>(op.tinout::<bfloat>(0, 0)?, op.f32(0)?),
        ...
        "attention.kv_append" => match op.dtype(Site::In(0))? {
            ScalarKind::Bf16 => Attention::kv_append::<bfloat>(ctx, op.tin::<bfloat>(0)?, op.tin::<bfloat>(1)?, op.pages()?),
        ...
        "attention.kv_append_shared" => match op.dtype(Site::In(0))? {
            ScalarKind::Bf16 => ctx.kv_append_shared::<bfloat>(op.tin::<bfloat>(0)?, op.pages()?),
