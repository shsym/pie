...
// `tests/device_sources.rs` now refuses two definitions of one
...
// The scalar layer is the PRELUDE's, not this family's, and the kernels below
// spell it unqualified: `pie` encloses `pie::ssm`, so `bf16` is `pie::bf16`.
