...
// workspace. It was `build_xqa_metadata_kernel` in the archive crate's
// `kernels-cuda/kernels/attn/attention_xqa.cu:55-83` -- **the last
...
// `kernels-cuda/src/table/attn.rs`'s `attn::attention_xqa_decode_bf16_prepared`
