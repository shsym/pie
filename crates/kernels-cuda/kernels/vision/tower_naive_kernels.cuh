...
//   * `CUDART_INF_F` became `pos_inf()`. Same bit pattern, and
//     `math_constants.h` is one of the 31 headers NVRTC answered 0 of.
//
// The fold in `k_rms` and `k_layernorm` is deliberately NOT `block_sum`.
...
///
/// The same four lines as `pie::norm::residual_add`, and they stay separate
