...
pub const CLAIMED: &[(&str, Option<Site>, &[ScalarKind])] = &[
    ...
    ("attention.merge_lse", Some(Site::Out(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
    ...
    ("attention.kv_append_shared", Some(Site::In(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
    ("mla.latents", Some(Site::Out(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
    ("mla.latents_rope", Some(Site::Out(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
    ("mla.split_q_b", Some(Site::Out(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
    ("mla.absorb_q", Some(Site::Out(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
    ("mla.absorb_out", Some(Site::Out(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
    ("mla.kv_append", Some(Site::In(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
    ("mla.attention_decode", Some(Site::Out(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
    ("mla.attention_prefill", Some(Site::Out(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
    ("mla.attention_decode_selected", Some(Site::Out(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
    ("mla.attention_prefill_selected", Some(Site::Out(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
    ("index.layernorm_rope", Some(Site::Out(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
    ("index.rope", Some(Site::Out(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
    ("index.topk", Some(Site::In(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
    ("index.kv_append", Some(Site::In(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
    ("pool.boundary_decode", None, &[ScalarKind::Bf16, ScalarKind::F32]),
    ("pool.boundary_prefill", None, &[ScalarKind::Bf16, ScalarKind::F32]),
    ("pool.gather", Some(Site::Out(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
    ("pool.kv_append", Some(Site::In(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
    ("pool.attention_lse", Some(Site::Out(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
    ("hc.expand", Some(Site::Out(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
    ("hc.rmsnorm_f32", Some(Site::In(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
    ("hc.gates", Some(Site::Out(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
    ("hc.fold", Some(Site::Out(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
];

pub const TIER2: &[(&str, Option<Site>, &[ScalarKind])] = &[
    ("qkv_fused_qknorm_rope_vnorm_write", Some(Site::Out(0)), &[ScalarKind::Bf16, ScalarKind::F32]),
];
    ...
    B: BoundOp<Plane = Ctx<'p>>,
{
    match op.point() {
        ...
        "attention.merge_lse" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.merge_lse::<bf16>(op.tin::<bf16>(0)?, op.tin::<f32>(1)?, op.tin::<bf16>(2)?, op.tin::<f32>(3)?, op.u32(0)?, op.u32(1)?, op.tout::<bf16>(0)?, op.tout::<f32>(1)?),
            ScalarKind::F32 => ctx.merge_lse::<f32>(op.tin::<f32>(0)?, op.tin::<f32>(1)?, op.tin::<f32>(2)?, op.tin::<f32>(3)?, op.u32(0)?, op.u32(1)?, op.tout::<f32>(0)?, op.tout::<f32>(1)?),
        ...
        "attention.kv_append_shared" => match op.dtype(Site::In(0))? {
            ScalarKind::Bf16 => ctx.kv_append_shared::<bf16>(op.tin::<bf16>(0)?, op.pages()?),
            ScalarKind::F32 => ctx.kv_append_shared::<f32>(op.tin::<f32>(0)?, op.pages()?),
        ...
        "mla.latents" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.latents::<bf16>(op.tin::<bf16>(0)?, op.tconst::<bf16>(0)?, op.f32(0)?, op.u32(1)?, op.tout::<bf16>(0)?, op.tout::<bf16>(1)?),
            ScalarKind::F32 => ctx.latents::<f32>(op.tin::<f32>(0)?, op.tconst::<f32>(0)?, op.f32(0)?, op.u32(1)?, op.tout::<f32>(0)?, op.tout::<f32>(1)?),
        ...
        "mla.latents_rope" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.latents_rope::<bf16>(op.tin::<bf16>(0)?, op.tin::<i32>(1)?, op.tconst::<bf16>(0)?, op.f32(0)?, op.u32(1)?, op.u32(2)?, op.f32(3)?, op.tout::<bf16>(0)?, op.tout::<bf16>(1)?),
            ScalarKind::F32 => ctx.latents_rope::<f32>(op.tin::<f32>(0)?, op.tin::<i32>(1)?, op.tconst::<f32>(0)?, op.f32(0)?, op.u32(1)?, op.u32(2)?, op.f32(3)?, op.tout::<f32>(0)?, op.tout::<f32>(1)?),
        ...
        "mla.split_q_b" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.split_q_b::<bf16>(op.tin::<bf16>(0)?, op.u32(0)?, op.u32(1)?, op.u32(2)?, op.tout::<bf16>(0)?, op.tout::<bf16>(1)?),
            ScalarKind::F32 => ctx.split_q_b::<f32>(op.tin::<f32>(0)?, op.u32(0)?, op.u32(1)?, op.u32(2)?, op.tout::<f32>(0)?, op.tout::<f32>(1)?),
        ...
        "mla.absorb_q" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.absorb_q::<bf16>(op.tin::<bf16>(0)?, op.tconst::<bf16>(0)?, op.u32(0)?, op.u32(1)?, op.u32(2)?, op.u32(3)?, op.tout::<bf16>(0)?),
            ScalarKind::F32 => ctx.absorb_q::<f32>(op.tin::<f32>(0)?, op.tconst::<f32>(0)?, op.u32(0)?, op.u32(1)?, op.u32(2)?, op.u32(3)?, op.tout::<f32>(0)?),
        ...
        "mla.absorb_out" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.absorb_out::<bf16>(op.tin::<bf16>(0)?, op.tconst::<bf16>(0)?, op.u32(0)?, op.u32(1)?, op.u32(2)?, op.u32(3)?, op.tout::<bf16>(0)?),
            ScalarKind::F32 => ctx.absorb_out::<f32>(op.tin::<f32>(0)?, op.tconst::<f32>(0)?, op.u32(0)?, op.u32(1)?, op.u32(2)?, op.u32(3)?, op.tout::<f32>(0)?),
        ...
        "mla.kv_append" => match op.dtype(Site::In(0))? {
            ScalarKind::Bf16 => Mla::kv_append::<bf16>(ctx, op.tin::<bf16>(0)?, op.tin::<bf16>(1)?, op.pages()?),
            ScalarKind::F32 => Mla::kv_append::<f32>(ctx, op.tin::<f32>(0)?, op.tin::<f32>(1)?, op.pages()?),
        ...
        "mla.attention_decode" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.attention_decode::<bf16>(op.tin::<bf16>(0)?, op.tin::<bf16>(1)?, op.pages()?, op.u32(0)?, op.u32(1)?, op.f32(2)?, op.tout::<bf16>(0)?),
            ScalarKind::F32 => ctx.attention_decode::<f32>(op.tin::<f32>(0)?, op.tin::<f32>(1)?, op.pages()?, op.u32(0)?, op.u32(1)?, op.f32(2)?, op.tout::<f32>(0)?),
        ...
        "mla.attention_prefill" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.attention_prefill::<bf16>(op.tin::<bf16>(0)?, op.tin::<i32>(1)?, op.tin::<bf16>(2)?, op.pages()?, op.u32(0)?, op.u32(1)?, op.f32(2)?, op.tout::<bf16>(0)?),
            ScalarKind::F32 => ctx.attention_prefill::<f32>(op.tin::<f32>(0)?, op.tin::<i32>(1)?, op.tin::<f32>(2)?, op.pages()?, op.u32(0)?, op.u32(1)?, op.f32(2)?, op.tout::<f32>(0)?),
        ...
        "mla.attention_decode_selected" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.attention_decode_selected::<bf16>(op.tin::<bf16>(0)?, op.tin::<bf16>(1)?, op.tin::<i32>(2)?, op.pages()?, op.u32(0)?, op.u32(1)?, op.f32(2)?, op.tout::<bf16>(0)?),
            ScalarKind::F32 => ctx.attention_decode_selected::<f32>(op.tin::<f32>(0)?, op.tin::<f32>(1)?, op.tin::<i32>(2)?, op.pages()?, op.u32(0)?, op.u32(1)?, op.f32(2)?, op.tout::<f32>(0)?),
        ...
        "mla.attention_prefill_selected" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.attention_prefill_selected::<bf16>(op.tin::<bf16>(0)?, op.tin::<i32>(1)?, op.tin::<bf16>(2)?, op.tin::<i32>(3)?, op.pages()?, op.u32(0)?, op.u32(1)?, op.f32(2)?, op.tout::<bf16>(0)?),
            ScalarKind::F32 => ctx.attention_prefill_selected::<f32>(op.tin::<f32>(0)?, op.tin::<i32>(1)?, op.tin::<f32>(2)?, op.tin::<i32>(3)?, op.pages()?, op.u32(0)?, op.u32(1)?, op.f32(2)?, op.tout::<f32>(0)?),
        ...
        "index.layernorm_rope" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.layernorm_rope::<bf16>(op.tinout::<bf16>(0, 0)?, op.tin::<i32>(1)?, op.tconst::<bf16>(0)?, op.tconst::<bf16>(1)?, op.f32(0)?, op.u32(1)?, op.f32(2)?),
            ScalarKind::F32 => ctx.layernorm_rope::<f32>(op.tinout::<f32>(0, 0)?, op.tin::<i32>(1)?, op.tconst::<f32>(0)?, op.tconst::<f32>(1)?, op.f32(0)?, op.u32(1)?, op.f32(2)?),
        ...
        "index.rope" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.rope::<bf16>(op.tinout::<bf16>(0, 0)?, op.tin::<i32>(1)?, op.u32(0)?, op.u32(1)?, op.u32(2)?, op.f32(3)?),
            ScalarKind::F32 => ctx.rope::<f32>(op.tinout::<f32>(0, 0)?, op.tin::<i32>(1)?, op.u32(0)?, op.u32(1)?, op.u32(2)?, op.f32(3)?),
        ...
        "index.topk" => match op.dtype(Site::In(0))? {
            ScalarKind::Bf16 => ctx.topk::<bf16>(op.tin::<bf16>(0)?, op.tin::<bf16>(1)?, op.pages()?, op.u32(0)?, op.u32(1)?, op.u32(2)?, op.tout::<i32>(0)?),
            ScalarKind::F32 => ctx.topk::<f32>(op.tin::<f32>(0)?, op.tin::<f32>(1)?, op.pages()?, op.u32(0)?, op.u32(1)?, op.u32(2)?, op.tout::<i32>(0)?),
        ...
        "index.kv_append" => match op.dtype(Site::In(0))? {
            ScalarKind::Bf16 => Index::kv_append::<bf16>(ctx, op.tin::<bf16>(0)?, op.pages()?),
            ScalarKind::F32 => Index::kv_append::<f32>(ctx, op.tin::<f32>(0)?, op.pages()?),
        ...
        "pool.gather" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.gather::<bf16>(op.tin::<i32>(0)?, op.tin::<i32>(1)?, op.pages()?, op.u32(0)?, op.u32(1)?, op.tout::<bf16>(0)?),
            ScalarKind::F32 => ctx.gather::<f32>(op.tin::<i32>(0)?, op.tin::<i32>(1)?, op.pages()?, op.u32(0)?, op.u32(1)?, op.tout::<f32>(0)?),
        ...
        "pool.kv_append" => match op.dtype(Site::In(0))? {
            ScalarKind::Bf16 => Pool::kv_append::<bf16>(ctx, op.tin::<bf16>(0)?, op.tin::<i32>(1)?, op.tin::<i32>(2)?, op.pages()?),
            ScalarKind::F32 => Pool::kv_append::<f32>(ctx, op.tin::<f32>(0)?, op.tin::<i32>(1)?, op.tin::<i32>(2)?, op.pages()?),
        ...
        "pool.attention_lse" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.attention_lse::<bf16>(op.tin::<bf16>(0)?, op.tin::<i32>(1)?, op.pages()?, op.u32(0)?, op.u32(1)?, op.u32(2)?, op.f32(3)?, op.tout::<bf16>(0)?, op.tout::<f32>(1)?),
            ScalarKind::F32 => ctx.attention_lse::<f32>(op.tin::<f32>(0)?, op.tin::<i32>(1)?, op.pages()?, op.u32(0)?, op.u32(1)?, op.u32(2)?, op.f32(3)?, op.tout::<f32>(0)?, op.tout::<f32>(1)?),
        ...
        "hc.expand" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.expand::<bf16>(op.tin::<bf16>(0)?, op.u32(0)?, op.tout::<bf16>(0)?),
            ScalarKind::F32 => ctx.expand::<f32>(op.tin::<f32>(0)?, op.u32(0)?, op.tout::<f32>(0)?),
        ...
        "hc.rmsnorm_f32" => match op.dtype(Site::In(0))? {
            ScalarKind::Bf16 => ctx.rmsnorm_f32::<bf16>(op.tin::<bf16>(0)?, op.f32(0)?, op.tout::<f32>(0)?),
            ScalarKind::F32 => ctx.rmsnorm_f32::<f32>(op.tin::<f32>(0)?, op.f32(0)?, op.tout::<f32>(0)?),
        ...
        "hc.gates" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.gates::<bf16>(op.tin::<f32>(0)?, op.tin::<bf16>(1)?, op.tconst::<f32>(0)?, op.tconst::<f32>(1)?, op.u32(0)?, op.f32(1)?, op.f32(2)?, op.u32(3)?, op.tout::<bf16>(0)?, op.tout::<f32>(1)?, op.tout::<f32>(2)?),
            ScalarKind::F32 => ctx.gates::<f32>(op.tin::<f32>(0)?, op.tin::<f32>(1)?, op.tconst::<f32>(0)?, op.tconst::<f32>(1)?, op.u32(0)?, op.f32(1)?, op.f32(2)?, op.u32(3)?, op.tout::<f32>(0)?, op.tout::<f32>(1)?, op.tout::<f32>(2)?),
        ...
        "hc.fold" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.fold::<bf16>(op.tin::<bf16>(0)?, op.tin::<bf16>(1)?, op.tin::<f32>(2)?, op.tin::<f32>(3)?, op.tout::<bf16>(0)?),
            ScalarKind::F32 => ctx.fold::<f32>(op.tin::<f32>(0)?, op.tin::<f32>(1)?, op.tin::<f32>(2)?, op.tin::<f32>(3)?, op.tout::<f32>(0)?),
        ...
        "qkv_fused_qknorm_rope_vnorm_write" => match op.dtype(Site::Out(0))? {
            ScalarKind::Bf16 => ctx.qkv_fused_qknorm_rope_vnorm_write::<bf16>(op.tin::<bf16>(0)?, op.tin::<i32>(1)?, op.tconst::<bf16>(0)?, op.f32(0)?, op.tconst::<bf16>(1)?, op.f32(1)?, op.pages()?, op.u32(2)?, op.u32(3)?, op.f32(4)?, op.tout::<bf16>(0)?),
            ScalarKind::F32 => ctx.qkv_fused_qknorm_rope_vnorm_write::<f32>(op.tin::<f32>(0)?, op.tin::<i32>(1)?, op.tconst::<f32>(0)?, op.f32(0)?, op.tconst::<f32>(1)?, op.f32(1)?, op.pages()?, op.u32(2)?, op.u32(3)?, op.f32(4)?, op.tout::<f32>(0)?),
