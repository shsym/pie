...
pub enum Refusal {
    ...
    PrefillKvTileTooLarge {
        head_dim: u32,
        cta_tile_q: u32,
        fixed_smem: u32,
        per_mma_kv: u32,
    },
    PrefillTraitsInvalid {
        cta_tile_q: u32,
        num_mma_kv: u32,
        num_mma_d_vo: u32,
    },
    PrefillSmemOverBudget {
        smem_bytes: u32,
        limit: u32,
    },
}
...
impl PrefillGeometry {
    pub const ECHO_TEMPLATE: &'static str = "&::pie::attn::fa2::smem_bytes_paged";
    ...
    pub const fn derive(
        ...
        if invalid {
            return Err(Refusal::PrefillTraitsInvalid {
                cta_tile_q,
                num_mma_kv,
                num_mma_d_vo,
            });
