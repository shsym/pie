...
pub fn generate_c_header() -> String {
    ...
    s.push_str(&format!(
        ...
        crate::plan::COMPILER_VERSION,
        crate::plan::REGION_PLAN_VERSION,
        crate::plan::LANE_TABLE_ABI_VERSION
    ));
    ...
    s.push_str(&format!(
        ...
        crate::codegen::cuda::CUDA_GENERATED_EMITTER_VERSION,
        crate::codegen::metal::METAL_M1_EMITTER_VERSION
    ));
    s.push_str(&format!(
        "#define PTIR_METAL_M1_MAX_CHANNELS {}\n#define PTIR_METAL_M2_MAX_FUSED_CHANNELS {}\n",
        crate::codegen::metal::METAL_M1_MAX_CHANNELS,
    ...
    s.push_str(&format!(
        ...
        crate::codegen::metal::fused::METAL_M3_REGION_THREADS
    ));
