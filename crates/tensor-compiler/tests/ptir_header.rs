...
use tensor_compiler::codegen::header::generate_c_header;
...
fn drivers_do_not_retype_generated_tags() {
    ...
    let guarded = [
        (
            "crates/driver/include/pie/driver/fire/descriptor.hpp",
            "kPort",
            "PTIR_PORT_",
        ),
        (
            "crates/driver/include/pie/driver/launch/program.hpp",
            "StageKind",
            "PTIR_STAGE_",
        ),
    ];
