...
//! [`driver_abi::KvHandle`]: the [`KvRegion`]s backing the cache plus the
//! paged [`driver_abi::KvLayout`]. Transport's `Engine::register` consumes
...
use driver_abi::{KvDtype, KvExport, KvHandle, KvLayout, KvLayoutKind, KvRegion, MemoryDomain};
