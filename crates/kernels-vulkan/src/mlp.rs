...
pub static KERNELS: &[KernelSig] = &[
    ...
    kernel!(geglu_tanh "geglu_tanh", file = Some("mlp/gated.comp"),
    ...
    kernel!(geglu_tanh_strided "geglu_tanh_strided", file = Some("mlp/gated.comp"),
        launch = kernels::LaunchRule::Elementwise,
        operands = kernels::operands![
            gate: Buf <- kernels::Source::In(0),
            up: Buf <- kernels::Source::In(1),
    ...
    kernel!(gptoss_swiglu "gptoss_swiglu", file = Some("mlp/gated.comp"),
        launch = kernels::LaunchRule::Elementwise,
        operands = kernels::operands![
            gate: Buf <- kernels::Source::In(0),
            up: Buf <- kernels::Source::In(1),
        ...
        axes = &[BF16]),
    // 1 in mlp/gated.comp
    kernel!(silu_mul "silu_mul", file = Some("mlp/gated.comp"), launch = kernels::LaunchRule::Elementwise,
        operands = kernels::operands![
            gate: Buf <- kernels::Source::In(0),
            up: Buf <- kernels::Source::In(1),
            out: BufMut <- kernels::Source::Out(0),
