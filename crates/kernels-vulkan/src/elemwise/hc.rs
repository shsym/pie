...
pub fn expand(ctx: &Ctx<'_>, x: Tensor, streams: u32, y: Tensor) -> Result<(), Error> {
    ...
    ctx.fire(
        Fire::at("elemwise/hc_expand.slang", entry).apply(Grid::of(
...
pub fn rmsnorm_f32(ctx: &Ctx<'_>, streams: Tensor, eps: f32, y: Tensor) -> Result<(), Error> {
    ...
    ctx.fire(
        Fire::at("elemwise/hc_rmsnorm.slang", entry).apply(per_row(OP, y.rows)?),
        &[
            streams.arg(),
            y.arg_mut(),
...
pub fn project(
    ...
    ctx.fire(
        Fire::at("elemwise/hc_project.slang", "hc_project").apply(per_row(OP, points)?),
        &[
            normed.arg(),
            hc_fn.arg(),
            mixes.arg_mut(),
...
pub fn gates(
    ...
    ctx.fire(
        Fire::at("elemwise/hc_gates.slang", entry).apply(per_row(OP, x.rows)?),
        &[
            normed.arg(),
            scale.arg(),
            base.arg(),
...
pub fn fold(
    ...
    ctx.fire(
        Fire::at("elemwise/hc_fold.slang", entry).apply(Grid::of(
...
pub fn collapse(
    ...
    ctx.fire(
        Fire::at("elemwise/hc_collapse.slang", entry).apply(per_row(OP, y.rows)?),
        &[
            mixes.arg(),
            scale.arg(),
            base.arg(),
...
pub fn mix(
    ...
    ctx.fire(
        Fire::at("elemwise/hc_mix.slang", entry).apply(Grid::of(
...
pub fn inject(
    ...
    ctx.fire(
        Fire::at("elemwise/hc_inject.slang", entry).apply(Grid::of(
...
pub fn ple_gate(
    ...
    ctx.fire(
        Fire::at("elemwise/hc_ple_gate.slang", entry).apply(per_row(OP, groups)?),
        &[
            key.arg(),
            query.arg(),
            value.arg(),
