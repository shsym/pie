...
//! [`crate::store::recurrent_layout`] already holds the stride and offset
//! arithmetic; this module is the object that owns the four buffers and turns
//! runtime requests into stream operations.
//!
//! Structured the same way as [`crate::store::kv_cache`]: every device
...
use crate::store::recurrent_layout::{RecurrentShape, RecurrentStateLayout};
