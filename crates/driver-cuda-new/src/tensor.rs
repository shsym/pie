...
pub struct DeviceTensor {
    spec: TensorSpec,
    buffer: Option<crate::cuda::DeviceBuffer>,
}
...
impl DeviceTensor {
    ...
    pub fn allocate(alloc: &crate::cuda::Allocator, spec: TensorSpec) -> Result<Self> {
    ...
    pub fn as_ptr(&self) -> *mut core::ffi::c_void {
        self.buffer
            .as_ref()
            .map_or(core::ptr::null_mut(), crate::cuda::DeviceBuffer::as_ptr)
    }
