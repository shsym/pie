...
use driver_cuda_new::ptir::{Disk, Module, disk_key, nvrtc};
...
/// unusable one.
///
/// [`Deterministic`]: driver_cuda_new::ptir::FailureKind::Deterministic
#[test]
fn a_source_nvrtc_rejects_is_deterministic_and_carries_its_log() {
    ...
    assert_eq!(
        error.kind,
        driver_cuda_new::ptir::FailureKind::Deterministic,
...
fn the_control_kernels_compile_and_both_entry_points_resolve() {
    use driver_cuda_new::ptir::{Control, control};
