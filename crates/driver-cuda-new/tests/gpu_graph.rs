...
mod common;
use driver_cuda_new::cuda::{Allocator, DeviceBuffer, OwnedStream, StreamRef};
...
/// into.
fn fill_body_with_memset(body: driver_cuda_new::cudarc::runtime::sys::cudaGraph_t, buf: &DeviceBuffer, v: u8) {
    use driver_cuda_new::cudarc::runtime::sys as rt;
