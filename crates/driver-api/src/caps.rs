...
//! engine used to rebuild a `ModelProfile` out of those booleans at bind time
...
/// Which directions this driver's `copy_kv` serves.
///
...
/// past any of them is [`DriverError::Impossible`](crate::DriverError::Impossible)
/// rather than [`Exhausted`](crate::DriverError::Exhausted): freeing pages
