...
//
// The prelude specialises `device::Elem` for `bf16` and `f16` and names no
...
// family's namespace, and the rows say `moe::device::f32`. A `device::f32`
...
///
/// `device::Elem` would do this and is specialised for `bf16` and `f16` only;
