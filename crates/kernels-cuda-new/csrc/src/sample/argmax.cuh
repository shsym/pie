...
// `<<<>>>`, no stream. Three rows in `kernels_cuda_new::families::sample`
...
namespace pie_cuda_driver::kernels::sample::device {
...
// `kernels::sample` and spell every cast `device::bf16` -- resolve that
...
using ::pie_cuda_driver::kernels::device::ldg;
