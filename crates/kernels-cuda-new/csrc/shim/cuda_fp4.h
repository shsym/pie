...
//    `examples/fp8_pipeline_probe.rs` gates fp8 on bit-parity against nvcc
//    over a million inputs; fp4 could be gated on nothing at all. A
//    conversion nobody can test, in a file nobody in our closure calls, is
//    two liabilities and no asset.
//
