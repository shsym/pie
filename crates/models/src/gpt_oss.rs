...
pub const IMPORTS: &[crate::ImportRow] = &[
    ("gptoss-20b-mlxu4-mxfp4-kv-bf16", 1, |src, tp| {
        Model::b20(Dtype::U4g64, Dtype::Mxfp4, Dtype::Bf16, tp).import(src)
    }),
    ("gptoss-20b-bf16-mxfp4-kv-bf16", 1, |src, tp| {
        Model::b20(Dtype::Bf16, Dtype::Mxfp4, Dtype::Bf16, tp).import(src)
    }),
    ("gptoss-120b-bf16-mxfp4-kv-bf16", 1, |src, tp| {
        Model::b120(Dtype::Bf16, Dtype::Mxfp4, Dtype::Bf16, tp).import(src)
    }),
    ("gptoss-120b-bf16-mxfp4-kv-bf16-tp2", 2, |src, tp| {
        Model::b120(Dtype::Bf16, Dtype::Mxfp4, Dtype::Bf16, tp).import(src)
    }),
];
