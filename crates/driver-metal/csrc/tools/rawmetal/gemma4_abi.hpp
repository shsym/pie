...
// Re-export the shared per-kernel bind enums from decode_abi.hpp.
...
using pie::metal::bind::Rms;
using pie::metal::bind::Rope;
using pie::metal::bind::Sdpa;
using pie::metal::bind::Embed;
using pie::metal::bind::KvAppend;
using pie::metal::bind::Qmv;
using pie::metal::bind::Argmax;
