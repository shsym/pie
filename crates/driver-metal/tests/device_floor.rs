...
//!
//! ```text
//! cargo test -p driver-metal --release --test device_floor -- --nocapture
//! ```
...
use driver_metal::device::{self, Buffer, Context, Handles, Pipelines};
use driver_metal::encode::Sink;
