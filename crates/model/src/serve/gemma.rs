use crate::serve::decoders::{GenericChatDecoder, NoopReasoningDecoder, NoopToolDecoder};
use crate::serve::instruct::{ChatDecoder, Instruct, ReasoningDecoder, ToolDecoder};
use std::sync::Arc;
