...
pub const CATALOG: &[(&str, model_dsl::TraceFn)] = model_dsl::catalog![
    (
        ...
        model_dsl::trace,
        Model::<ShippedW1, ShippedW2, ShippedKv>::b20(),
    ),
    (
        "gptoss-120b-bf16-mxfp4-kv-bf16",
        model_dsl::trace,
        Model::<ShippedW1, ShippedW2, ShippedKv>::b120(),
    ),
    (
        "gptoss-120b-bf16-mxfp4-kv-bf16-tp2",
        model_dsl::trace,
        Model::<ShippedW1, ShippedW2, ShippedKv, 2>::b120(),
    ),
];
...
model_dsl::allow_import! {
    ...
    import_hf::<SfBf16, ShippedW1, ShippedW2, ShippedKv> => ("gptoss-120b-bf16-mxfp4-kv-bf16-tp2", Model::<ShippedW1, ShippedW2, ShippedKv, 2>::b120()),
}
