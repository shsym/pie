...
impl Model {
    pub fn a12b(w: Dtype, experts: Dtype, act: Dtype, kv: Dtype, tp: u32) -> Model {
        assemble(
            w,
            experts,
            act,
        ...
        .map(|l| {
            ...
            let attn = Attn {
                ...
                indexer: Indexer {
                    ...
                    k_proj: Weight::sym(n("index_k_proj"), [d.index_head_dim as u64, hidden], w),
                    ...
                    k_norm_bias: Weight::sym(n("index_k_norm_bias"), [d.index_head_dim as u64], w),
                    keys: format!("index.{l}"),
                },
                kv: format!("kv.{l}"),
            };
