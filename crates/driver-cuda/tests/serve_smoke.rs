...
//!   cargo test -p driver-cuda --features cuda-13 --test serve_smoke -- --nocapture
//! ```
//!
...
/// The lane word the model's own `Classify` computes — engine-side work, done
/// here because this test IS the engine for the length of one fire.
