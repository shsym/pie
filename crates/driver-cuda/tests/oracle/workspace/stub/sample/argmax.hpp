#pragma once
// Stub for the `kArgmaxAccumSlots` that the ARCHIVE crate's
// `csrc/src/sample/argmax.hpp` used to publish. §54 deleted that header
// along with its launchers, which became
// `driver-cuda/src/fire/lm_head_argmax.rs`.
//
// `workspace.cpp` takes one constant from it and none of the launchers. The
// value is NOT retyped here: `run.sh` derives it from `kernels-cuda/csrc/
