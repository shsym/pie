...
// (crates/driver-metal/csrc/src/context.cpp: interval = first full index + 1, then the
// stack is checked against it and an irregular stack is refused instead of
// silently mis-scheduled; crates/driver-metal/csrc/src/model/qwen3_5/geometry.hpp::
