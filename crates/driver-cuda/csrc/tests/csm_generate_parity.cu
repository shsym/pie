...
// weights).
//
//   nvcc -O2 -arch=sm_89 -std=c++17 -diag-suppress 550 -I crates/driver-cuda/csrc/src \
//        crates/driver-cuda/csrc/tests/csm_generate_parity.cu \
//        crates/driver-cuda/csrc/src/model/csm/csm_depth_decoder_forward.cu \
//        crates/driver-cuda/csrc/src/model/csm/mimi_decoder_forward.cu -o /tmp/cgp
//   /tmp/cgp
#include <cstdint>
#include <cstdio>
#include <cstdlib>
