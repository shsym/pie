...
//! IR's canonical [`eta::op::Op`](eta_ir::op::Op); composed ops (`gumbel`,
...
/// Runs one `eta_ir::expand` sequence over `x` and returns its typed result.
...
/// Masked argmax expressed over ordinary ETA primitives.
