...
/// in-process [`Flavor`] (C++/Rust static lib) or an out-of-process
/// [`SubprocessFlavor`] (Python `pie_driver_<name>` wheel).
///
...
/// embedded [`Flavor`]; subprocess flavors pass their `[driver.options]`
/// table through to the launcher untyped (see
/// [`crate::subprocess_driver::write_subprocess_startup_toml`]) and
